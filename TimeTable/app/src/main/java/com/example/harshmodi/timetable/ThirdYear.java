...
public class ThirdYear extends AppCompatActivity {
    ...
    private void setupUI(){
        toolbar = (Toolbar)findViewById(R.id.Toolbar3Y);
        listView = (ListView)findViewById(R.id.lv3Y);
    ...
    private void setupListView() {
        ...
        ThirdYear.SimpleAdapter simpleAdapter = new ThirdYear.SimpleAdapter(this, title, description);
            ...
            if(titleArray[i].equalsIgnoreCase("First Semester")){
                ...
                check.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent myIntent1 = new Intent(view.getContext(), ThirdYFirstS.class);
                ...
                check.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent myIntent1 = new Intent(view.getContext(), ThirdYSecondS.class);
                        startActivity(myIntent1);
                    }
                });
            }

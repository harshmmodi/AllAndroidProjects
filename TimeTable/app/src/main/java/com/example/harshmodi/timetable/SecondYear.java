...
public class SecondYear extends AppCompatActivity {
    ...
    private void setupUI(){
        toolbar = (Toolbar)findViewById(R.id.Toolbar2Y);
        listView = (ListView)findViewById(R.id.lv2Y);
    ...
    private void setupListView() {
        ...
        SecondYear.SimpleAdapter simpleAdapter = new SecondYear.SimpleAdapter(this, title, description);
            ...
            if(titleArray[i].equalsIgnoreCase("First Semester")){
                ...
                check.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent myIntent1 = new Intent(view.getContext(), SecondYFirstS.class);
                ...
                check.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent myIntent1 = new Intent(view.getContext(), SecondYSecondS.class);
                        startActivity(myIntent1);
                    }
                });
            }
